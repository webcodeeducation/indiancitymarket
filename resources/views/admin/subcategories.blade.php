...
<head>
	...
	<title>Indiancitymarket Admin Panel: Subcategory</title>
...
<section class="content">
  ...
  <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal">Add SubCategory</button>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="/admin/saveSubCategory" method="post" id="subcategoryform" enctype="multipart/form-data">
          	<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                <div class="form-group">
      <label class="control-label col-sm-2" for="category">Category Image:</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-primary btnSaveSubCategory1">Submit</button>
      </div>
    </div>
  </form>
        </div>
...
<!-- tile body -->
                            <table class="table table-bordered ajaxTable tblsubcategories" id="tblsubcategories" width="100%" cellspacing="0">
                              <thead>
                                <tr>
                                  <th>Category</th>
                                  <th>Main Category</th>
