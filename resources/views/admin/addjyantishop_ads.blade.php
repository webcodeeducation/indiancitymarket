...
<div class="row">
<div class="col-sm-4">
<form class="form-horizontal" action="/createjyantiads" method="post" id="createjyantiads" enctype="multipart/form-data">
            {{ csrf_field() }}

        <div class="form-group">
      <label class="control-label col-sm-2" for="shop_number">Shop Number:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="shop_number" placeholder="Enter Shop Type" name="shop_number" value="" required="required">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="shop_image">Shop Image:</label>
      <div class="col-sm-10">
        <!--input type="file" id="shop_image" name="shop_image" required="required"-->
        <input type="file" name="shop_image" id="shop_image"/>
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="shop_category">Shop Category:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="shop_category" placeholder="Enter Shop Category" name="shop_category" value="" required="required">
      </div>
    </div>
