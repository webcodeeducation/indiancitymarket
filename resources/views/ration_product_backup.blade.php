...
<section class="container products">
     <div class="row justify-content-around border p-3 align-items-center">

      <div class="col-6 col-lg-2 mb-3">
        <img src="rajma.jpg" class="img-fluid">
      </div>
      <div class="col-6 col-lg-4 mb-3">
        <p><span class="font-weight-bold text-c1">Name: </span><span>Rajma</span></p>
        <p><span class="font-weight-bold text-c1">Weight: </span><span>1kg</span></p>
        <p><span class="font-weight-bold text-c1">Rate: </span><span> Rs.120/-</span></p>
        <p><span class="font-weight-bold text-c1">Mrp(Rs.): </span><span>150/-</span></p>
        <p><span class="font-weight-bold text-c1">Save(Rs.): </span><span>30/-</span></p>
        <button class="btn btn-danger text-sm"><i class="fa fa-plus" aria-hidden="true"></i>
Add to Cart</button>
      </div>
...
<div class="row">
  		...
  		<form action="/ration-products" method="post">
  			{{csrf_field()}}
  <div class="form-group">
    <label for="pwd">Search Product:</label>
