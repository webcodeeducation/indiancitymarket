...
<section class="content">
  ...
  <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal">Add Service</button>
...
<fieldset>
                            ...
                            <div class="form-group row">
                                <label for="shopname" class="col-md-4 col-form-label text-md-right">Category</label>
                                <div class="col-md-6">
                                    <div id="service_category_response_here"></div>
                                    <input type="text" id="service_cat" class="form-control" name="service_cat" value="" required="" autofocus="">
                                    <button type="button" class="btn btn-primary btnSaveServiceCategory">Save</button>
                                </div>
                            </div>
