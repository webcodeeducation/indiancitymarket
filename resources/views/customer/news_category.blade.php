...
<section class="content">
  ...
  <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#createNewsModal">Create News</button>
...
@endif
  <!-- Modal -->
  <div class="modal fade" id="createNewsModal" role="dialog">
        ...
        <div class="modal-body">
          <form action="" method="post" id="registerform">
                          ...
                          <div class="form-group row">
                                <label for="shopname" class="col-md-4 col-form-label text-md-right">News Image</label>
                                <div class="col-md-6">
