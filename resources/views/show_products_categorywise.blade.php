  ...
  <strong>Sorry!</strong> No Product Found.
    ...
    @foreach($products->chunk(4) as $items)
      ...
      <div class="col-6 col-lg-4 mb-3">
        <p><span class="font-weight-bold text-c1">Name: </span><span>{{ $item->product_name }}</span><br>
        <span class="font-weight-bold text-c1">Weight: </span><span>{{$item->product_weight}}</span><br>
        <span class="font-weight-bold text-c1">Rate: </span><span> {{$item->product_price}}/-</span><br>
        <!--span class="font-weight-bold text-c1">Mrp(Rs.): </span><span>{{$item->product_mrp}}/-</span><br>
        <span class="font-weight-bold text-c1">Save(Rs.): </span><span>{{$item->product_save_mrp}}/-</span></p-->
