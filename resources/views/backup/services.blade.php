			...
			<div class="w3ls_service_grids">
				...
				<div class="col-md-7 w3ls_service_grid_right">
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="{{ URL::asset('public/assets/grocery/images/18.jpg') }}" alt=" " class="img-responsive" />
					</div>
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="{{ URL::asset('public/assets/grocery/images/19.jpg') }}" alt=" " class="img-responsive" />
					</div>
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="{{ URL::asset('public/assets/grocery/images/20.jpg') }}" alt=" " class="img-responsive" />
					</div>
	...
	<div class="services-bottom">
		<div class="container">
			...
			<!-- Stats-Number-Scroller-Animation-JavaScript -->
				<script src="{{ URL::asset('public/assets/grocery/js/waypoints.min.js') }}"></script> 
				<script src="{{ URL::asset('public/assets/grocery/js/counterup.min.js') }}"></script> 
				<script>
